...
interface NavbarProps {
    activePage?: 'dashboard' | 'produk' | 'pesanan' | 'pengguna' | 'carousel' | 'beranda';
    showAdminNav?: boolean;
}

export default function Navbar({ activePage = 'beranda', showAdminNav = false }: NavbarProps) {
    ...
    return (
        <nav className="relative z-50 border-b border-[#19140035] bg-white">
            ...
            {showAdminNav && <AdminNavLinks activePage={activePage} />}
        </nav>
    );
}